...
type WalletTransactionCountProps = {
...
export class WalletTransactionCount extends ValueObject<WalletTransactionCountProps> {
  constructor(value: WalletTransactionCountProps) {
    super(value);
  }

  public getValue(limitType: WalletLimitType, transactionType: WalletTransactionType): number {
    return this.getValueObj(limitType, transactionType).value ?? Infinity;
  }

  public increment(transactionType: WalletTransactionType): WalletTransactionCount {
  ...
  public merge(value: Record<string, unknown>): WalletTransactionCount {
    return new WalletTransactionCount({ ...this.value, ...value });
  }
